...
<table width="780" border="0" cellpadding="0" cellspacing="0" class="tabletextSimple">
  <tr>
    <td width="227"><a href="/admin/panel"><img src="../images/ecoLOGO.gif" width="192" height="83" border="0" /></a><a href="/admin/panel"></a></td>
    <td colspan="2"><img src="../images/disthead.jpg" width="554" height="120" /></td>
  </tr>
  <tr>
