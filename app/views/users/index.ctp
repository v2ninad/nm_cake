<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('repurchase');?></th>
			<th><?php echo $this->Paginator->sort('paid');?></th>
			<th><?php echo $this->Paginator->sort('accounts');?></th>
			<th><?php echo $this->Paginator->sort('closing');?></th>
			<th><?php echo $this->Paginator->sort('cms');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo h($user['User']['repurchase']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['paid']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['accounts']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['closing']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['cms']); ?>&nbsp;</td>
