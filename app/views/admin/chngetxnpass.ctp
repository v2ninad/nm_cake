<br>
<span class="pagetitle">- Change Transaction Password -</span>
<blockquote>
	<form name="officeday" action="<?=$this->Form->url('/admin/chngetxnpass/')?>" method="post" >
